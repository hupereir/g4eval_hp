/*
 * Convert TPOT alignment translation offset, given in centimeter unit, and local coordinates
 * into global coordinates, and millimeter units, suitable for modifying the alignment parameters
...
namespace
{
   ...
   * first parameter are hitsetkey, used to identify individual Micromegas detectors
   */
